const contractAddress = "0xa60Af0cD549caEf23aBBC81fd8fe4F7De48f08a1"; //Replace with your own contract address
...
const h1_presale_mint = "Minting starting soon!!";
...
const p_presale_mint_not_whitelisted = "Enter our Clubhouse and wait for the Public mint";
const p_presale_mint_whitelisted = "You're on the whitelist for the pre-sale! 🎉";
const p_presale_mint_already_minted = "Enter our Clubhouse and wait for the Public mint";
const p_public_mint = " Enjoy your Mint 🎉";
const button_presale_coming_soon = "You can wait in our Clubhouse";
